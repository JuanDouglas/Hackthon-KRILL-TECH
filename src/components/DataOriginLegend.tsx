...
export const DataOriginLegend: React.FC<DataOriginLegendProps> = ({ 
  ...
  return (
    <div className={`bg-[#1C1915] border border-[#2E2A22] rounded-2xl p-4 text-xs font-sans transition-all ${className}`}>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        <div className="flex items-center gap-2">
          <ShieldCheck className="h-4 w-4 text-[#E0A94E] shrink-0" />
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-[#4A6FE0]/25 text-[#F0D9A8] border border-[#4A6FE0]/50 text-[10px] font-display font-bold">
            <Sparkles className="h-3 w-3 text-[#E0A94E]" />
          ...
          <button
            ...
            className="p-1 rounded-lg text-stone-400 hover:text-white hover:bg-[#242019] transition-all cursor-pointer ml-1"
      ...
      {isExpanded && (
        <div className="mt-4 pt-4 border-t border-[#2E2A22] grid grid-cols-1 md:grid-cols-3 gap-3 animate-fade-in text-[11px] leading-relaxed">
          {/* Layer 1 Detail */}
          <div className="p-3 rounded-xl bg-[#151310] border border-emerald-500/30 space-y-1">
          ...
          {/* Layer 2 Detail */}
          <div className="p-3 rounded-xl bg-[#151310] border border-[#4A6FE0]/40 space-y-1">
            <div className="flex items-center gap-1.5 text-[#F0D9A8] font-display font-bold">
          ...
          {/* Layer 3 Detail */}
          <div className="p-3 rounded-xl bg-[#151310] border border-amber-500/40 border-dashed space-y-1">
