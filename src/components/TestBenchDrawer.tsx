...
export const TestBenchDrawer: React.FC<TestBenchDrawerProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
      ...
      {/* Drawer Panel */}
      <div className="relative w-full max-w-lg bg-[#09090e] border-l border-[#231c3a] shadow-2xl h-full flex flex-col z-10 animate-slide-left text-slate-100 font-sans">
        {/* Drawer Header */}
        <div className="p-5 border-b border-[#231c3a] bg-[#0e0e17] flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="h-9 w-9 rounded-xl bg-[#6618F7]/20 border border-[#6618F7]/40 flex items-center justify-center text-[#8b4dff]">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 rounded text-[9px] font-display font-bold bg-[#6618F7]/30 text-[#a78bfa] border border-[#6618F7]/50 uppercase tracking-wider">
                  Lab Desacoplado
                </span>
              </div>
          ...
          <button
            onClick={onClose}
            className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-[#141422] transition-all cursor-pointer"
        ...
        {/* Audit Disclaimer */}
        <div className="bg-[#141422] px-5 py-2.5 border-b border-[#231c3a] flex items-center gap-2 text-[11px] text-[#a78bfa]">
        ...
        {/* Toast Notification */}
        {successToast && (
          <div className="mx-5 mt-4 p-3 rounded-xl bg-[#6618F7]/20 border border-[#6618F7]/50 text-[#d8b4fe] text-xs flex items-center gap-2 animate-fade-in font-sans">
        ...
        <div className="flex-1 overflow-y-auto p-5 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <select
              ...
              className="w-full bg-[#0e0e17] border border-[#231c3a] focus:border-[#6618F7] text-white text-xs rounded-xl p-3 outline-none font-sans"
            >
              {portfolio.map((p) => (
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <div className="grid grid-cols-1 gap-2">
                <button
                  ...
                  className="p-3 rounded-xl bg-[#0e0e17] hover:bg-[#141422] border border-[#231c3a] hover:border-rose-500/50 text-left transition-all active:scale-[0.99] cursor-pointer group"
                >
            ...
            <div className="space-y-2 pt-2 border-t border-[#231c3a]">
              ...
              <div className="grid grid-cols-1 gap-2">
                <button
                  ...
                  className="p-3 rounded-xl bg-[#0e0e17] hover:bg-[#141422] border border-[#231c3a] hover:border-amber-500/50 text-left transition-all active:scale-[0.99] cursor-pointer group"
                >
                  <div className="flex justify-between items-center mb-1">
            ...
            <div className="space-y-2 pt-2 border-t border-[#231c3a]">
              <span className="text-[11px] font-display font-bold text-[#a78bfa] flex items-center gap-1.5">
              ...
              <div className="grid grid-cols-1 gap-2">
                <button
                  ...
                  className="p-3 rounded-xl bg-[#0e0e17] hover:bg-[#141422] border border-[#231c3a] hover:border-[#6618F7]/50 text-left transition-all active:scale-[0.99] cursor-pointer group"
                >
                  <div className="flex justify-between items-center mb-1">
                    <span className="text-xs font-display font-bold text-white group-hover:text-[#a78bfa]">
                      Injetar Dívida Ativa Federal (R$ 840 mil)
                    </span>
                    <span className="text-[10px] font-display font-bold text-[#a78bfa] bg-[#6618F7]/20 px-2 py-0.5 rounded border border-[#6618F7]/30">
                      -90 pts
                    </span>
                  </div>
                  <p className="text-[11px] text-slate-400 font-sans">
          ...
          {/* Execution History */}
          {logs.length > 0 && (
            <div className="space-y-2 pt-4 border-t border-[#231c3a]">
              <div className="flex items-center gap-1.5 text-xs font-display font-bold text-slate-300">
                <History className="h-3.5 w-3.5 text-[#8b4dff]" />
              ...
              <div className="space-y-1.5 max-h-48 overflow-y-auto pr-1">
                {logs.map((item) => (
                  <div
                    key={item.id}
                    className="p-2.5 rounded-lg bg-[#0e0e17] border border-[#231c3a] text-[11px] flex items-center justify-between font-sans"
                  >
                    <div>
        ...
        {/* Footer */}
        <div className="p-4 border-t border-[#231c3a] bg-[#0e0e17] flex items-center justify-between">
          <span className="text-[11px] text-slate-400 font-sans">
            Os alertas gerados aparecem na aba <strong>Alerta RJ</strong> e no <strong>Monitoramento</strong> com a tag [SIMULAÇÃO].
          </span>
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-xl bg-[#6618F7] hover:bg-[#7b2cff] text-white text-xs font-display font-bold transition-all cursor-pointer"
          >
            Concluir Testes
          </button>
        </div>
