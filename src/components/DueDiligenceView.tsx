...
export const DueDiligenceView: React.FC<DueDiligenceViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto">
      {/* Top Banner */}
      <div className="bg-[#151310] border border-[#2E2A22] rounded-2xl p-6 shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <div className="flex items-center gap-2 mb-1.5">
            <span className="px-2.5 py-0.5 rounded text-xs font-display font-bold bg-[#4A6FE0]/20 text-[#E0A94E] border border-[#4A6FE0]/40 uppercase tracking-wider">
              Análise Pré-Crédito • Novos Clientes
            </span>
            <span className="text-xs text-stone-500 font-display">Módulo 2 • Due Diligence Pré-Crédito</span>
          </div>
          <h2 className="text-2xl font-display font-black text-white tracking-tight">
            Due Diligence Automatizada (Concessão da 1ª Linha)
          </h2>
          <p className="text-xs text-stone-300 mt-1 max-w-3xl font-sans leading-relaxed">
        ...
        {pipelineResult?.report && (
          <button
            ...
            className="px-4 py-2 rounded-lg text-xs font-sans font-bold bg-[#242019] text-[#E0A94E] border border-[#4A6FE0]/50 hover:bg-[#4A6FE0]/20 hover:border-[#4A6FE0] flex items-center gap-2 transition-all shrink-0 active:scale-95 shadow-lg"
          >
