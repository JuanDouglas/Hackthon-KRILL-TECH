...
export const ExecutiveDashboardView: React.FC<ExecutiveDashboardViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-fade-in max-w-7xl mx-auto pb-10">
      {/* Hero Welcome Banner */}
      <div className="bg-gradient-to-r from-[#151310] via-[#1C1915] to-[#242019] border border-[#2E2A22] rounded-3xl p-6 sm:p-7 shadow-2xl relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-[#4A6FE0]/10 rounded-full blur-3xl pointer-events-none -mr-20 -mt-20" />
        
        <div className="relative z-10 flex flex-col lg:flex-row lg:items-center justify-between gap-5">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2">
              <span className="px-3 py-1 rounded-full text-xs font-display font-bold bg-[#4A6FE0]/20 text-[#E0A94E] border border-[#4A6FE0]/40 uppercase tracking-wider flex items-center gap-1.5">
                <Activity className="h-3.5 w-3.5 text-[#E0A94E] animate-pulse" />
              ...
              <a
                ...
                className="px-2.5 py-0.5 rounded-full text-[11px] font-display font-bold bg-[#242019] text-[#E0A94E] hover:text-white border border-[#2E2A22] hover:border-[#4A6FE0]/60 flex items-center gap-1 transition-colors"
                title="Conheça a equipe BroCode Softwares"
              >
                <span>Por BroCode Softwares (brocode.net.br)</span>
                <ExternalLink className="h-3 w-3" />
              </a>
              <span className="text-xs text-stone-500 font-display">Safra 2025/2026</span>
            </div>
          ...
          <div className="flex flex-wrap sm:flex-nowrap items-center gap-3 shrink-0">
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-[#4A6FE0] hover:bg-[#6584E8] text-white font-sans font-bold text-xs shadow-lg shadow-[#4A6FE0]/30 flex items-center gap-2 transition-all active:scale-95 cursor-pointer"
            >
            ...
            <button
              ...
              className="px-4 py-2.5 rounded-xl bg-[#242019] hover:bg-[#2A2419] text-[#E0A94E] border border-[#2E2A22] hover:border-[#4A6FE0]/60 font-sans font-bold text-xs flex items-center gap-2 transition-all active:scale-95 cursor-pointer"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {/* KPI 1 */}
        <div className="bg-[#151310] border border-[#2E2A22] rounded-2xl p-5 shadow-xl hover:border-[#4A6FE0]/40 transition-all">
          <div className="flex items-center justify-between text-stone-400 mb-2">
            <span className="text-xs font-display font-medium uppercase tracking-wider">
              Exposição Total
            </span>
            <span className="text-xs text-stone-500 font-display">8 tomadores</span>
          </div>
          ...
          <div className="mt-2.5 pt-2.5 border-t border-[#2E2A22] flex items-center justify-between text-[11px] text-stone-400 font-sans">
        ...
        {/* KPI 2 */}
        <div className="bg-[#151310] border border-rose-500/30 rounded-2xl p-5 shadow-xl hover:border-rose-500/60 transition-all">
          <div className="flex items-center justify-between text-stone-400 mb-2">
        ...
        {/* KPI 3 */}
        <div className="bg-[#151310] border border-amber-500/30 rounded-2xl p-5 shadow-xl hover:border-amber-500/40 transition-all">
          <div className="flex items-center justify-between text-stone-400 mb-2">
          ...
          <div className="mt-2.5 pt-2.5 border-t border-[#2E2A22] text-[11px] text-stone-400 font-sans">
            Sinais prévios antes do atraso financeiro formal
          </div>
        </div>

        {/* KPI 4 */}
        <div className="bg-[#151310] border border-emerald-500/30 rounded-2xl p-5 shadow-xl hover:border-emerald-500/40 transition-all">
          <div className="flex items-center justify-between text-stone-400 mb-2">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          <div className="bg-[#151310] border border-[#2E2A22] rounded-2xl p-5 sm:p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-[#2E2A22]">
              <div className="flex items-center gap-2.5">
                <BarChart3 className="h-4 w-4 text-[#E0A94E]" />
                <h2 className="text-base font-display font-bold text-white">
                  Radar Macroeconômico & Climático da Safra
                </h2>
              </div>
              <span className="text-xs font-display text-stone-400">Safra 2025/2026</span>
            </div>

            {/* Visual Scannable Grid: Concise Chips Instead of Long Paragraphs */}
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              {/* Driver 1 */}
              <div className="p-3 rounded-xl bg-[#1C1915] border border-[#2E2A22] flex items-center justify-between gap-3">
          ...
          <div className="bg-[#151310] border border-[#2E2A22] rounded-2xl p-5 sm:p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-[#2E2A22]">
              <div className="flex items-center gap-2">
                <Clock className="h-4 w-4 text-[#E0A94E]" />
                <h3 className="text-base font-display font-bold text-white">
                  Fila de Ações do Operador
                </h3>
              </div>
              <span className="text-xs text-stone-400 font-display">Tarefas Prioritárias</span>
            </div>

            <div className="space-y-2.5">
              {/* Task 1 */}
              <div className="p-3 rounded-xl bg-[#1C1915] border border-[#2E2A22] flex items-center justify-between gap-3 hover:border-[#4A6FE0]/50 transition-all">
                <div className="flex items-center gap-3">
                  <div className="h-8 w-8 rounded-lg bg-[#4A6FE0]/10 text-[#E0A94E] flex items-center justify-center shrink-0">
                    <UserCheck className="h-4 w-4" />
                  </div>
                  <div>
                ...
                <button
                  onClick={() => onNavigateTab('triagem')}
                  className="px-3 py-1.5 rounded-lg bg-[#242019] hover:bg-[#4A6FE0] text-stone-300 hover:text-white border border-[#2E2A22] text-xs font-display font-bold flex items-center gap-1.5 shrink-0 transition-all cursor-pointer"
                >
                  <span>Acessar</span>
              ...
              {/* Task 2 */}
              <div className="p-3 rounded-xl bg-[#1C1915] border border-[#2E2A22] flex items-center justify-between gap-3 hover:border-rose-500/50 transition-all">
                <div className="flex items-center gap-3">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-[#151310] border border-[#2E2A22] rounded-2xl p-6 shadow-2xl space-y-4">
            <div className="flex items-center justify-between pb-3 border-b border-[#2E2A22]">
              <div className="flex items-center gap-2">
                <PieChart className="h-4 w-4 text-[#E0A94E]" />
                <h3 className="text-sm font-display font-bold text-white">
                  Distribuição da Carteira por Rating
                </h3>
              </div>
              <span className="text-[10px] font-display text-stone-400">Scorecard WoE</span>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs font-sans">
                  ...
                  <span className="text-stone-300">{primeClients.length} tomadores (25%)</span>
                </div>
                <div className="h-2 w-full bg-[#242019] rounded-full overflow-hidden">
                  <div className="h-full bg-emerald-500 rounded-full" style={{ width: '25%' }} />
                </div>
                <span className="text-[10px] text-stone-500 block font-sans">Baixo Risco • Prazo padrão 180 dias</span>
              </div>

              {/* Rating B */}
              <div className="space-y-1">
                <div className="flex justify-between text-xs font-sans">
                  <span className="font-display font-bold text-[#E0A94E]">Rating B (600-799 pts)</span>
                  <span className="text-stone-300">{moderateClients.length} tomadores (25%)</span>
                </div>
                <div className="h-2 w-full bg-[#242019] rounded-full overflow-hidden">
                  <div className="h-full bg-[#4A6FE0] rounded-full" style={{ width: '25%' }} />
                </div>
                <span className="text-[10px] text-stone-500 block font-sans">Risco Moderado • Prazo encurtado 120d</span>
              </div>
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs font-sans">
                  ...
                  <span className="text-stone-300">{highRiskClients.length} tomadores (25%)</span>
                </div>
                <div className="h-2 w-full bg-[#242019] rounded-full overflow-hidden">
                  <div className="h-full bg-amber-500 rounded-full" style={{ width: '25%' }} />
                </div>
                <span className="text-[10px] text-stone-500 block font-sans">Alerta Precoce • CPR Física ou Barter mandatório</span>
              </div>
              ...
              <div className="space-y-1">
                <div className="flex justify-between text-xs font-sans">
                  ...
                  <span className="text-stone-300">{criticalClients.length} tomadores (25%)</span>
                </div>
                <div className="h-2 w-full bg-[#242019] rounded-full overflow-hidden">
                  <div className="h-full bg-rose-500 rounded-full" style={{ width: '25%' }} />
                </div>
                <span className="text-[10px] text-stone-500 block font-sans">Risco Crítico / RJ • Bloqueio de novas concessões</span>
              </div>
            </div>

            <div className="pt-3 border-t border-[#2E2A22]">
              <button
                onClick={() => onNavigateTab('monitoramento')}
                className="w-full py-2 rounded-xl bg-[#1C1915] hover:bg-[#242019] text-[#E0A94E] hover:text-white border border-[#2E2A22] text-xs font-display font-bold text-center transition-all cursor-pointer"
              >
          ...
          {/* Quick Guide Card */}
          <div className="bg-[#151310] border border-[#2E2A22] rounded-2xl p-6 shadow-2xl space-y-3">
            <h4 className="text-xs font-display font-bold text-white uppercase tracking-wider flex items-center gap-1.5">
              <FileText className="h-3.5 w-3.5 text-[#E0A94E]" />
            ...
            <div className="pt-2 flex flex-col gap-2">
              <button
                ...
                className="w-full py-2 px-3 rounded-xl bg-[#242019] hover:bg-[#4A6FE0]/20 text-stone-200 border border-[#2E2A22] hover:border-[#4A6FE0]/50 text-xs font-display font-bold text-left flex items-center justify-between transition-all cursor-pointer"
              >
                <span>Manual Operacional do Sistema</span>
                <ArrowRight className="h-3.5 w-3.5 text-[#E0A94E]" />
              </button>
              <button
