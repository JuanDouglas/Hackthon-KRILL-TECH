...
export const BorrowerSelector: React.FC<BorrowerSelectorProps> = ({
  ...
  return (
    <div className="rounded-2xl p-5 shadow-2xl border transition-all bg-[#151310] border-[#2E2A22]">
      {/* Selector Header */}
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-4 border-b border-[#2E2A22]">
        <div>
          <div className="flex items-center gap-2">
            <span className="text-[10px] font-display uppercase tracking-wider font-bold px-2 py-0.5 rounded bg-[#4A6FE0]/20 text-[#E0A94E] border border-[#4A6FE0]/40">
              {isPF ? 'Pessoa Física • Produtor Rural' : 'Pessoa Jurídica • Revenda de Insumos'}
            </span>
            <span className="text-stone-500 font-sans text-xs">• Caso Selecionado</span>
          </div>

          <h2 className="text-xl font-display font-black text-white flex items-center gap-2.5 mt-1">
            <div className="h-7 w-7 rounded-lg bg-[#4A6FE0]/20 text-[#E0A94E] flex items-center justify-center border border-[#4A6FE0]/30">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-[11px] font-display text-stone-400 mr-1 hidden sm:inline">Casos de Teste:</span>
          {MOCK_CASES.map((item) => {
              ...
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-sans font-medium transition-all flex items-center gap-1.5 ${
                  isSelected
                    ...
                    : 'bg-[#1C1915] text-stone-400 border border-[#2E2A22] hover:border-[#4A6FE0]/40 hover:text-white'
      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3 pt-4 text-xs">
        <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
          <span className="text-stone-400 block mb-0.5 text-[11px]">Documento</span>
        ...
        <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
          <span className="text-stone-400 block mb-0.5 text-[11px] flex items-center gap-1">
          ...
          <span className="text-[10px] text-stone-400 block mt-0.5">Região Produtora</span>
        </div>
        ...
        <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
          ...
          <span className="text-[10px] text-stone-400 block mt-0.5">Fornecimento Krill Tech</span>
        </div>

        {isPF && pf ? (
          <>
            <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
              <span className="text-stone-400 block mb-0.5 text-[11px]">Cultura / Área</span>
            ...
            <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
              <span className="text-stone-400 block mb-0.5 text-[11px]">Cadastro CAR</span>
              <span
              ...
              <span className="text-[10px] text-stone-400 block mt-0.5 truncate" title={pf.carNumber}>
          ...
          <>
            <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
              <span className="text-stone-400 block mb-0.5 text-[11px]">CNAE Principal</span>
              <span className="font-mono font-bold text-teal-400 text-xs">{pj.cnae}</span>
              <span className="text-[10px] text-stone-400 block mt-0.5 truncate" title={pj.cnaeDescription}>
                Revenda Defensivos
              </span>
            </div>

            <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
              <span className="text-stone-400 block mb-0.5 text-[11px]">Tempo Regular</span>
            ...
            <div className="bg-stone-950/70 p-3 rounded-xl border border-stone-800/80">
              <span className="text-stone-400 block mb-0.5 text-[11px]">Modelo de Negócio</span>
      ...
      <div className="mt-3.5 pt-3 border-t border-stone-800/80 flex flex-col sm:flex-row sm:items-center justify-between gap-2 text-[11px] text-stone-400">
